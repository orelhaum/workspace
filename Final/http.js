...
let getUrlCoins = ()=>{ return `${domain}/coins`;}
let getMethodCoins = ()=>{ return "GET";};

//market
//const urlMarket = `${domain}/market/:coin`;
//const methodMarket = "GET";
let getUrlMarket = ()=>{ return `${domain}/market/:coin`;}
let getMethodMarket = ()=>{ return "GET";};

//historical
//const urlHistorical = `${domain}/historical/:coin/:hours`;
//const methodHistorical = "GET";
let getUrlHistorical = ()=>{ return `${domain}/historical/:coin/:hours`;}
let getMethodHistorical = ()=>{ return "GET";};

//prediction
//const urlPrediction = `${domain}/prediction/:hours`;
//const methodPrediction = "GET";
let getUrlPrediction = ()=>{ return `${domain}/prediction/:hours`;}
let getMethodPrediction = ()=>{ return "GET";};

//info_user
//const urlInfoUser = `${domain}/info_users`;
//const methodInfoUser = "GET";
let getUrlInfoUser = ()=>{ return `${domain}/info_users`;}
let getMethodInfoUser = ()=>{ return "GET";};

//funds
//const urlFunds = `${domain}/funds`;
//const methodFunds = "POST";
let getUrlFunds = ()=>{ return `${domain}/funds`;}
let getMethodFunds = ()=>{ return "POST";};

//buy
//const urlBuy = `${domain}/buy/:coin/:cantidad`;
//const methodBuy = "POST";
let getUrlBuy = ()=>{ return `${domain}/buy/:coin/:cantidad`;}
let getMethodBuy = ()=>{ return "POST";};

//sell
//const urlSell = `${domain}/sell/:coin/:cantidad`;
//const methodSell = "POST";
let getUrlSell  = ()=>{ return `${domain}/sell/:coin/:cantidad`;}
let getMethodSell  = ()=>{ return "POST";};

//msg list
//const urlList = `${domain}/msg/list`;
//const methodList = "POST";
let getUrlMsgList = ()=>{ return `${domain}/msg/list`;}
let getMethodList = ()=>{ return "POST";};

//msg send
//const urlSend = `${domain}/msg/send`;
//const methodSend = "POST";
let getUrlSend = ()=>{ return `${domain}/msg/send`;}
let getMethodSend = ()=>{ return "POST";};

//msg read
//const urlRead = `${domain}/msg/read/:idMessage`;
//const methodRead = "POST";
let getUrlRead = ()=>{ return `${domain}/msg/read/:idMessage`;}
let getMethodRead = ()=>{ return "POST";};

//msg remove
//const urlMsgRemove = `${domain}/msg/remove/:idMessage`;
//const methodMsgRemove = "POST";
let getUrlMsgRemove = ()=>{ return `${domain}/msg/remove/:idMessage`;}
let getMethodMsgRemove = ()=>{ return "POST";};

//msg remove_all
let getUrlMsgRemoveAll = ()=>{ return `${domain}/msg/remove_all`;}
let getMethodMsgRemoveAll = ()=>{ return "POST";};

class Http {
  constructor() {}
  
  sendHttp(method, url, data,  callback) {
    $.ajax({method,url,data}).done((msg) => {
      //console.log("OK",this);
...
class ServicioWeb extends Http {
  ...
  postHttp(jsonData, callback) {
    console.log('ejecutamos postHttp');
    if (jsonData.ok){
...
export let servicioWeb = { ServicioWeb }